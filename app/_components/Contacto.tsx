      ...
      <div className="grid lg:grid-cols-2 gap-8 items-start">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="glass-card p-5 flex items-start gap-4">
            ...
            >
              <MapPinIcon className="w-5 h-5 text-blue-300" aria-hidden="true" />
            </div>
            <div>
              <div className="text-white font-semibold text-sm mb-0.5">Dirección</div>
              <div className="text-[var(--text-muted)] text-sm">
                General Gana # 924, Santiago, Chile
              </div>
            </div>
          </div>
          ...
          <div className="glass-card p-5 flex items-start gap-4">
            ...
            >
              <PhoneIcon className="w-5 h-5 text-blue-300" aria-hidden="true" />
            </div>
            <div>
              <div className="text-white font-semibold text-sm mb-0.5">Teléfono</div>
              <a
                href="tel:+56975587223"
                className="text-[var(--text-muted)] text-sm hover:text-white transition-colors hover:underline"
          ...
          <div className="glass-card p-5 flex items-start gap-4">
            ...
            >
              <MailIcon className="w-5 h-5 text-blue-300" aria-hidden="true" />
            </div>
            <div>
              <div className="text-white font-semibold text-sm mb-0.5">Correo Electrónico</div>
              <a
          ...
          <div className="glass-card p-5 flex items-start gap-4">
            ...
            >
              <ClockIcon className="w-5 h-5 text-blue-300" aria-hidden="true" />
            </div>
            <div>
              <div className="text-white font-semibold text-sm mb-1">Horarios de Atención</div>
              <div className="text-[var(--text-muted)] text-sm">
                Lunes a Domingos: 9:00 AM – 7:00 PM
              </div>
            </div>
          </div>
          ...
          <div className="glass-card p-5">
            <div className="text-white font-semibold text-sm mb-3">Redes Sociales</div>
